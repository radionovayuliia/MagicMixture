...
// 							cat1));
// 			coctelService.añadir(
// 					new Coctel(0L, "Caipirinha", TipoCoctel.Aperetivo, "piña", 30.00f, 4, cat1));
// 			coctelService.añadir(
...
// 					coctelService.añadir(
// 					new Coctel(0L, "Pasión", TipoCoctel.Aperetivo, "tequila, frutas de la pasión, limón", 30.00f, 5,
// 							cat1));
// 			coctelService.añadir(
// 					new Coctel(0L, "Americano", TipoCoctel.Aperetivo, "vermut, campari, soda", 27.00f, 6, cat2));
// 			coctelService.añadir(
// 					new Coctel(0L, "Angel", TipoCoctel.Aperetivo, "ginebra, triple sec, jugo de limón", 29.00f, 7, cat3));
// 			coctelService.añadir(
// 					new Coctel(0L, "Barracuda", TipoCoctel.LongDrink, "ron, licor de anís, jugo de piña", 33.00f, 8, cat4));
// 			coctelService.añadir(
// 					new Coctel(0L, "Bramble", TipoCoctel.Aperetivo, "ginebra, licor de mora, jugo de limón", 32.00f, 9,
// 							cat5));
// 			coctelService.añadir(
// 					new Coctel(0L, "Brezza", TipoCoctel.Aperetivo, "vodka, jugo de toronja, soda", 26.00f, 6, cat6));
// 			coctelService.añadir(
// 					new Coctel(0L, "Bull shot", TipoCoctel.LongDrink, "vodka, caldo de res, salsa Worcestershire", 28.00f, 7, cat2));
